...
const commands = ['start','light','stop']
...
console.log("customDropdownOptions");
...
//The Classes were initially named Up Down Left Right, but it is now being used to refer the classes of Appliances like TV, AC, etc
